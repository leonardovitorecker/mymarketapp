...
type
  Tdm = class(TDataModule)
    ...
    FDQueryProdEX: TFDQuery;
    FDQueryProdEXid: TFDAutoIncField;
    FDQueryProdEXnomeProduto: TStringField;
    FDQueryProdEXestoque: TIntegerField;
    FDQueryProdEXvalorProduto: TBCDField;
    FDQueryProdEXlaboratorio: TStringField;
    FDQueryProdEXimg_produto: TBlobField;
    FDQueryProdEXcarrinho: TIntegerField;
