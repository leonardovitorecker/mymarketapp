...
type
  ...
  public
  idGlobal: integer;
  procedure CarregarListaProdutoss(id: String; nome: string;
 ...
 procedure TFrmLoginUsuario.GetProdutosBase1;
  begin
    ...
    while not dm.FDQueryProduto.Eof do
     begin
       CarregarListaProdutoss(dm.FDQueryProdutoid.AsString,
   ...
   procedure TFrmLoginUsuario.CarregarListaProdutoss(id: String; nome: string;
  estoque: String;laboratorio: string; valor: String);
  var
  frame: TFrame1;
  begin
